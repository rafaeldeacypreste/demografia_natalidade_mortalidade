...
Em primeiro lugar, pode-se acessar as projeções populacionais por sexo e idade. Os dados de projeção populacional do IBGE podem ser acessados em: 
...
nMx_PE_2020 <-
  ...
  mutate(
    "nMx Masc" = Obitos_masc / Pop_masc_2020,
...
```{r}
nMx_PE_2020 %>%
  rename("Feminino"  = `nMx Fem`,
         "Masculino" = `nMx Masc`) %>%
  select(Faixa_etaria, Masculino, Feminino) %>%
  pivot_longer(
