...
```{r}
dados_sinasc <- fread("C:/Users/rafae/OneDrive/Documentos/Estatistica/Demografia/Atividades/Trabalho1/dados_sinasc.csv", encoding = "UTF-8")
```
...
```{r}
dados_sinasc_2021 <- fread("C:/Users/rafae/OneDrive/Documentos/Estatistica/Demografia/Atividades/Trabalho1/dados_sim_2021.csv", encoding = "UTF-8")
```
...
```{r}
dados_sim <- fread("C:/Users/rafae/OneDrive/Documentos/Estatistica/Demografia/Atividades/Trabalho1/dados_sim.csv", encoding = "UTF-8")
```
...
```{r}
dados_sim_2021 <- fread("C:/Users/rafae/OneDrive/Documentos/Estatistica/Demografia/Atividades/Trabalho1/dados_sim_2021.csv", encoding = "UTF-8")
```
...
`r media_nascimentos_19_21/ sum(pop_tot_2020) * 1000`
...
`r (nascimentos_total_21 / 382499) + (nascimentos_total_21 / 407176) + (nascimentos_total_21 / 393940) + (nascimentos_total_21 / 403316) + (nascimentos_total_21 / 368470) + (nascimentos_total_21 / 328946)`
